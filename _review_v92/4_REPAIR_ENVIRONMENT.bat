...
title Kakao Emoticon v92 Repair

echo.
echo ============================================================
echo  Kakao Emoticon Profit System v92 - Repair Environment
echo ============================================================
echo.
...
echo [v92] Stopping old Streamlit port...
%PY_CMD% scripts\stop_port.py %PORT%

echo [v92] Rebuilding Python virtual environment...
...
echo.
echo [v92] Repair completed. Run 00_STEP_3_START_PROGRAM.bat.
pause
exit /b 0
