...
$shortcuts = @(
  @{Name='Kakao Emoticon v51'; Target='2_START_PROGRAM.bat'},
  @{Name='Kakao Emoticon v51 - Repair'; Target='4_REPAIR_ENVIRONMENT.bat'},
  @{Name='Kakao Emoticon v51 - Diagnostics'; Target='6_RUN_DIAGNOSTICS.bat'},
  @{Name='Kakao Emoticon v51 - Outputs'; Target='5_OPEN_OUTPUTS.bat'},
  @{Name='Kakao Emoticon v51 - API Guardrail Check'; Target='18_V51_API_GUARDRAIL_LEDGER_CHECK.bat'},
  @{Name='Kakao Emoticon v51 - Clean Old Versions'; Target='14_V51_CLEAN_OLD_VERSIONS.bat'}
)
