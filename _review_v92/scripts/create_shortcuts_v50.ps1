...
$shortcuts = @(
  @{Name='Kakao Emoticon v50'; Target='2_START_PROGRAM.bat'},
  @{Name='Kakao Emoticon v50 - Repair'; Target='4_REPAIR_ENVIRONMENT.bat'},
  @{Name='Kakao Emoticon v50 - Diagnostics'; Target='6_RUN_DIAGNOSTICS.bat'},
  @{Name='Kakao Emoticon v50 - Outputs'; Target='5_OPEN_OUTPUTS.bat'},
  @{Name='Kakao Emoticon v50 - Full Check'; Target='16_V50_STATIC_ANIMATED_EVOLUTION_CHECK.bat'},
  @{Name='Kakao Emoticon v50 - Clean Old Versions'; Target='14_V50_CLEAN_OLD_VERSIONS.bat'}
)
