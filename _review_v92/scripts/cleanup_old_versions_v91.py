...
def run(mode: str, scan_roots: list[Path], current_version: int, current_path: Path | None, output_root: Path, confirm: str | None, yes: bool) -> dict:
    ...
    report_path = output_root / f"v91_old_version_cleanup_{mode}_{timestamp}.json"
...
def parse_args(argv: list[str] | None = None) -> argparse.Namespace:
    ap = argparse.ArgumentParser(description="Kakao Emoticon v91 safe old-version cleanup tool")
