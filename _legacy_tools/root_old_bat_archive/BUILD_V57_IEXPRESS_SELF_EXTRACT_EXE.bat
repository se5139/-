...
cd /d "%~dp0"
echo [v57] Building fallback self-extracting EXE with Windows IExpress...
...
"%SystemRoot%\System32\iexpress.exe" /N "%CD%\installer\KakaoEmoticonSetup_v57_IExpress.sed"
