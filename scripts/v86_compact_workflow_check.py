...
if '86.0.0' not in const or 'v86' not in const:
    errors.append('constants not updated to v86')
...
allowed = {'00_DOUBLE_CLICK_THIS_FIRST_BUILD_SETUP_EXE.bat','00_STEP_1_BUILD_SETUP_EXE.bat','00_STEP_2_PORTABLE_INSTALL_NOW.bat','00_STEP_3_START_PROGRAM.bat','0_BUILD_WINDOWS_INSTALLER_EXE.bat','1_INSTALL_NOW.bat','2_START_PROGRAM.bat','3_CREATE_SHORTCUTS_ONLY.bat','4_REPAIR_ENVIRONMENT.bat','5_OPEN_OUTPUTS.bat','6_RUN_DIAGNOSTICS.bat','OPEN_V86_INNO_SCRIPT.bat','46_V86_COMPACT_WORKFLOW_CHECK.bat','47_V86_WINDOWS_FILENAME_SAFETY_CHECK.bat','14_V86_CLEAN_OLD_VERSIONS_AND_EXTRACTED.bat','run_cleanup_old_versions_v86.bat','START_WINDOWS.bat'}
...
if errors:
    ...
    for e in errors:
        print(' -', e)
    raise SystemExit(1)
print('[v86][PASS] compact workflow markers found')
print('[v86][PASS] root BAT count:', len(root_bats))
print('[v86][PASS] root BATs:', ', '.join(sorted(root_bats)))
