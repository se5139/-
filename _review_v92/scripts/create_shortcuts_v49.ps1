...
$shortcuts = @(
  @{Name='Kakao Emoticon v49'; Target='2_START_PROGRAM.bat'},
  @{Name='Kakao Emoticon v49 - Repair'; Target='4_REPAIR_ENVIRONMENT.bat'},
  @{Name='Kakao Emoticon v49 - Diagnostics'; Target='6_RUN_DIAGNOSTICS.bat'},
  @{Name='Kakao Emoticon v49 - Outputs'; Target='5_OPEN_OUTPUTS.bat'},
  @{Name='Kakao Emoticon v49 - Full Check'; Target='16_V49_STATIC_ANIMATED_EVOLUTION_CHECK.bat'},
  @{Name='Kakao Emoticon v49 - Clean Old Versions'; Target='14_V49_CLEAN_OLD_VERSIONS.bat'}
)
