...
def write_reports(report: dict, backup_root: Path) -> None:
    ...
    lines = [
        "Kakao Emoticon v59 old-version cleanup report",
...
def main(argv: list[str] | None = None) -> int:
    ...
    backup_root = local / "KakaoEmoticonProfitSystemUserData" / "old_version_cleanup_backups" / ("v59_" + now_stamp())
