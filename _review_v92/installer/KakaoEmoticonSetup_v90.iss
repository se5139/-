...
Name: "cleanupold"; Description: "After successful upgrade, backup then remove old v89-and-lower folders"; GroupDescription: "Maintenance:"; Flags: checkedonce
...
[Run]
Filename: "{cmd}"; Parameters: "/C ""{app}\_advanced_tools\advanced_bat\run_cleanup_old_versions_v90_after_upgrade_delete.bat"""; WorkingDir: "{app}"; Flags: waituntilterminated; Tasks: cleanupold
