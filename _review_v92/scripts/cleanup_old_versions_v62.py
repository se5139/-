...
def write_reports(report: dict, backup_root: Path) -> None:
    ...
    lines = [
        "Kakao Emoticon v62 old-version cleanup report",
...
def main(argv: list[str] | None = None) -> int:
    ...
    backup_root = local / "KakaoEmoticonProfitSystemUserData" / "old_version_cleanup_backups" / ("v62_" + now_stamp())
